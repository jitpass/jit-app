...
final class DoctorOwnershipTests: XCTestCase {
    ...
    "path":"wrap-clisso/blockaid-client-secret",
    "detail":"~/.clisso.yaml points at wrap-clisso/blockaid-client-secret, which isn't in the vault",
    "action":"`jit vault set wrap-clisso/blockaid-client-secret`",
    "fixes":[{"command":"jit vault set wrap-clisso/blockaid-client-secret","argv":["vault","set",
    "wrap-clisso/blockaid-client-secret"],"destructive":false,"presence":true}],"file":"/Users/me/.clisso.yaml"}],
